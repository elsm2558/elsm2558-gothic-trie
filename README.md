...
The sentence generator uses a Greedy First-Order Markov Chain. It lacks long-term context because each prediction is based solely on the current node in the Trie. While this accurately reflects the statistical probability of word pairs in the source text, it doesn't account for overarching sentence structure or grammar, leading to 'pseudo-Gothic' nonsense.
